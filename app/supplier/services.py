...
class SupplierService(remote.Service):
	...
	Supplier_MESSAGE_RESOURCE_CONTAINER = endpoints.ResourceContainer(SupplierPostMessage)
	Supplier_Search_MESSAGE_RESOURCE_CONTAINER = endpoints.ResourceContainer(SupplierSearchMessage)
